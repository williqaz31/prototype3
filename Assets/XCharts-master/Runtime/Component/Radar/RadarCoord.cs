...
namespace XCharts.Runtime
{
    ...
    public class RadarCoord : CoordSystem, ISerieContainer
    {
        ...
        public int gridIndex
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_GridIndex, value)) SetVerticesDirty();
            }
        }
        ...
        public AxisLine axisLine
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_AxisLine, value, true)) SetAllDirty();
            }
        }
        ...
        public AxisName axisName
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_AxisName, value, true)) SetAllDirty();
            }
        }
        ...
        public AxisSplitLine splitLine
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SplitLine, value, true)) SetAllDirty();
            }
        }
        ...
        public AxisSplitArea splitArea
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SplitArea, value, true)) SetAllDirty();
            }
        }
        ...
        {
            if (index >= 0 && index < m_IndicatorList.Count) return m_IndicatorList[index].min;
            return 0;
        }

        public double GetIndicatorMax(int index)
        {
            if (index >= 0 && index < m_IndicatorList.Count) return m_IndicatorList[index].max;
            return 0;
        }
        ...
        public string GetFormatterIndicatorContent(string indicatorName, int index, int totalIndex)
        {
            ...
            if (string.IsNullOrEmpty(m_AxisName.labelStyle.formatter)) return indicatorName;
        ...
        public class Indicator
        {
            ...
            public double[] range
            {
                ...
                set
                {
                    if (value != null && value.Length == 2) m_Range = value;
                }
            }
