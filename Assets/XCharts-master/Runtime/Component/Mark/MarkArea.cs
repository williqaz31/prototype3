...
namespace XCharts.Runtime
{
    ...
    public class MarkArea : MainComponent
    {
        ...
        public MarkAreaData start
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Start, value)) SetVerticesDirty();
            }
        }
        ...
        public MarkAreaData end
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_End, value)) SetVerticesDirty();
            }
        }
        ...
        public ItemStyle itemStyle
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_ItemStyle, value)) SetVerticesDirty();
            }
        }
        ...
        public LabelStyle label
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Label, value)) SetComponentDirty();
            }
        }
