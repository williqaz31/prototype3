...
namespace XCharts.Runtime
{
    ...
    public class DataZoom : MainComponent, IUpdateRuntimeData
    {
        ...
        [Range(1f, 20f)] [SerializeField] private float m_ScrollSensitivity = 1.1f;
        ...
        public bool supportMarquee
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_SupportMarquee, value)) SetVerticesDirty();
            }
        }
        ...
        public bool startLock
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_StartLock, value)) SetVerticesDirty();
            }
        }
        ...
        public bool endLock
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_EndLock, value)) SetVerticesDirty();
            }
        }
        ...
        public float minShowNum { set; get; }
        ...
        public float minZoomRatio
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinZoomRatio, value)) SetVerticesDirty();
            }
        }
        ...
        public MarqueeStyle marqueeStyle
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_MarqueeStyle, value)) SetAllDirty();
            }
        }
        ...
        public bool IsInMarqueeArea(Vector2 pos)
        {
            ...
            if (context.marqueeRect.width >= 0) return context.marqueeRect.Contains(pos);
