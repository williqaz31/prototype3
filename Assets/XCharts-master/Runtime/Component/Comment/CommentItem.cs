...
namespace XCharts.Runtime
{
    ...
    public class CommentItem : ChildComponent
    {
        ...
        [SerializeField] [Since("v3.5.0")] private Location m_Location = new()
            { align = Location.Align.BottomRight, right = 0.1f, bottom = 0.05f };
        ...
        public Rect markRect
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MarkRect, value)) SetVerticesDirty();
            }
        }
        ...
        public CommentMarkStyle markStyle
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_MarkStyle, value)) SetVerticesDirty();
            }
        }
