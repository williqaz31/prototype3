...
namespace XCharts.Runtime
{
    ...
    public class Comment : MainComponent, IPropertyChanged
    {
        ...
        [SerializeField] private List<CommentItem> m_Items = new() { new CommentItem() };
        ...
        public CommentLayer layer
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Layer, value)) SetComponentDirty();
            }
        }
        ...
        {
            foreach (var item in items) item.location.OnChanged();
        }
