...
namespace XCharts.Runtime
{
    public static class AnimationStyleHelper
    {
            ...
            float startPorgress = 0)
        {
            ...
            var currHig =
                serie.animation.CheckItemProgress(dataIndex, destProgress, ref isDataAnimationEnd, startPorgress);
            if (!isDataAnimationEnd) serie.animation.context.isAllItemAnimationEnd = false;
            return currHig;
        }
        ...
        public static bool GetAnimationPosition(AnimationStyle animation, bool isY, Vector3 lp, Vector3 cp,
            float progress, ref Vector3 ip, ref float rate)
        {
