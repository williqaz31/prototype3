...
namespace XCharts.Runtime
{
    ...
    public class VisualMap : MainComponent
    {
        ...
        [SerializeField] private int m_SerieIndex;
        [SerializeField] private double m_Min;
        [SerializeField] private double m_Max;
        ...
        [SerializeField] private bool m_Calculable;
        ...
        [SerializeField] private bool m_WorkOnArea;

        [SerializeField]
        private List<VisualMapRange> m_OutOfRange = new() { new VisualMapRange { color = Color.gray } };
        ...
        public bool showUI
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ShowUI, value)) SetVerticesDirty();
            }
        }
        ...
        public int serieIndex
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_SerieIndex, value)) SetVerticesDirty();
            }
        }
        ...
        public bool workOnLine
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_WorkOnLine, value)) SetVerticesDirty();
            }
        }
        ...
        public bool workOnArea
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_WorkOnArea, value)) SetVerticesDirty();
            }
        }
        ...
        public Color32 GetColor(double value)
        {
            ...
            if (m_Type == Type.Piecewise) return m_InRange[index].color;
        ...
        public int GetIndex(double value)
        {
            ...
            if (splitNumber <= 0)
                return -1;
            var index = -1;
            if (IsNeedPieceColor(value, out index)) return index;
        ...
        public double GetValue(Vector3 pos, Rect chartRect)
        {
            ...
            var centerPos = new Vector3(chartRect.x, chartRect.y) +
                            location.GetPosition(chartRect.width, chartRect.height);
