...
namespace XCharts.Runtime
{
    ...
    public class LabelLine : ChildComponent, ISerieComponent, ISerieDataComponent
    {
        ...
        [SerializeField] [Since("v3.8.0")] private float m_LineEndX;
        ...
        public float lineAngle
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_LineAngle, value)) SetVerticesDirty();
            }
        }
        ...
        public float lineEndX
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_LineEndX, value)) SetVerticesDirty();
            }
        }
