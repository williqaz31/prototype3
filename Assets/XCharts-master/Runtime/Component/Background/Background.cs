...
namespace XCharts.Runtime
{
    ...
    public class Background : MainComponent
    {
        ...
        [SerializeField] [Since("v3.10.0")] private float m_ImageWidth;
        [SerializeField] [Since("v3.10.0")] private float m_ImageHeight;
        ...
        public Sprite image
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Image, value)) SetComponentDirty();
            }
        }
        ...
        public Image.Type imageType
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ImageType, value)) SetComponentDirty();
            }
        }
        ...
        public Color imageColor
        {
            ...
            set
            {
                if (PropertyUtil.SetColor(ref m_ImageColor, value)) SetComponentDirty();
            }
        }
        ...
        public float imageWidth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ImageWidth, value)) SetComponentDirty();
            }
        }
        ...
        public float imageHeight
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ImageHeight, value)) SetComponentDirty();
            }
        }
        ...
        public BorderStyle borderStyle
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_BorderStyle, value)) SetComponentDirty();
            }
        }
