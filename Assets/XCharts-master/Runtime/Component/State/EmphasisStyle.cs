...
namespace XCharts.Runtime
{
    ...
    public class EmphasisStyle : StateStyle, ISerieComponent, ISerieDataComponent
    {
        ...
        public float scale
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Scale, value)) SetVerticesDirty();
            }
        }
        ...
        public FocusType focus
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Focus, value)) SetVerticesDirty();
            }
        }
        ...
        public BlurScope blurScope
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BlurScope, value)) SetVerticesDirty();
            }
        }
    }
}