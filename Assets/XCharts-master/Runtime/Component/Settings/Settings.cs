...
namespace XCharts.Runtime
{
    ...
    public class Settings : MainComponent
    {
        ...
        [SerializeField] protected bool m_ReversePainter;
        ...
        public Material upperPainterMaterial
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_UpperPainterMaterial, value)) SetComponentDirty();
            }
        }
        ...
        public float lineSmoothness
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_LineSmoothness, value < 0 ? 1f : value)) SetVerticesDirty();
            }
        }
        ...
        public float[] legendIconCornerRadius
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_LegendIconCornerRadius, value, true)) SetVerticesDirty();
            }
        }
        ...
        public float axisMaxSplitNumber
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_AxisMaxSplitNumber, value)) SetVerticesDirty();
            }
        }
