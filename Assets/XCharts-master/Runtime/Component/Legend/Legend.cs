...
namespace XCharts.Runtime
{
    ...
    public class Legend : MainComponent, IPropertyChanged
    {
        ...
        public float itemOpacity
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ItemOpacity, value)) SetComponentDirty();
            }
        }
        ...
        {
            get => m_ItemInactiveOpacity;
            set
            {
                if (PropertyUtil.SetStruct(ref m_ItemInactiveOpacity, value)) SetComponentDirty();
            }
        }
        ...
        public LabelStyle labelStyle
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_LabelStyle, value)) SetComponentDirty();
            }
        }
        ...
        public Padding padding
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Padding, value)) SetAllDirty();
            }
        }
        ...
        ///     组件是否需要刷新
        /// </summary>
        public override bool componentDirty => m_ComponentDirty || location.componentDirty ||
                                               labelStyle.componentDirty || textLimit.componentDirty;
        ...
        {
            if (context.buttonList.ContainsKey(name)) context.buttonList[name].SetIconColor(color);
        }
        ...
        {
            if (context.buttonList.ContainsKey(name)) context.buttonList[name].SetContentColor(color);
        }
        ...
        {
            if (index >= 0 && index < m_Icons.Count) return m_Icons[index];
