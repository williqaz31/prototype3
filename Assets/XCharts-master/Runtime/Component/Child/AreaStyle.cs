...
namespace XCharts.Runtime
{
    ...
    public class AreaStyle : ChildComponent, ISerieComponent, ISerieDataComponent
    {
        ...
        public AreaOrigin origin
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Origin, value)) SetVerticesDirty();
            }
        }
        ...
        public bool innerFill
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_InnerFill, value)) SetVerticesDirty();
            }
        }
        ...
        public bool toTop
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ToTop, value)) SetVerticesDirty();
            }
        }
