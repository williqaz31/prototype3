...
namespace XCharts.Runtime
{
    ...
    public class SymbolStyle : ChildComponent
    {
        ...
        [SerializeField] protected float m_Gap;
        ...
        [SerializeField] [Since("v3.13.0")] protected float m_BorderWidth;
        [SerializeField] [Since("v3.13.0")] protected Color32 m_EmptyColor;
        [SerializeField] [Since("v3.13.0")] protected float m_Size2;
        ...
        public float size2
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Size2, value)) SetVerticesDirty();
            }
        }
        ...
        public Color32 color
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Color, value)) SetAllDirty();
            }
        }
        ...
        public Color32 emptyColor
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_EmptyColor, value)) SetAllDirty();
            }
        }
        ...
        ///     ||带有涟漪特效动画的散点图的动画参数。
        /// </summary>
        public List<float> animationSize { get; } = new() { 0, 5, 10 };
