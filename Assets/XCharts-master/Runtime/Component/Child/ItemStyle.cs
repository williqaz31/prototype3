...
namespace XCharts.Runtime
{
    ...
    public class ItemStyle : ChildComponent, ISerieDataComponent
    {
        ...
        [SerializeField] private float m_BorderGap;
        ...
        public Color32 markColor
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MarkColor, value)) SetAllDirty();
            }
        }
        ...
        public float backgroundGap
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BackgroundGap, value)) SetVerticesDirty();
            }
        }
        ...
        public float borderGap
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BorderGap, value)) SetVerticesDirty();
            }
        }
        ...
        public string itemFormatter
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_ItemFormatter, value)) SetVerticesDirty();
            }
        }
        ...
        public string itemMarker
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_ItemMarker, value)) SetVerticesDirty();
            }
        }
        ...
        public float[] cornerRadius
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_CornerRadius, value, true)) SetVerticesDirty();
            }
        }
        ...
        public Color32 GetGradientColor(float value, Color32 defaultColor)
        {
            ...
            if (m_Opacity != 1) color.a = (byte)(color.a * m_Opacity);
            return color;
        }
