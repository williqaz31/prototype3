...
namespace XCharts.Runtime
{
    ...
    public class SerieSymbol : SymbolStyle, ISerieDataComponent
    {
        ...
        [SerializeField] private bool m_ForceShowLast;
        [SerializeField] private bool m_Repeat;
        [SerializeField] [Since("v3.3.0")] private float m_MinSize;
        [SerializeField] [Since("v3.3.0")] private float m_MaxSize;
        ...
        public SymbolSizeFunction sizeFunction
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SizeFunction, value)) SetVerticesDirty();
            }
        }
