...
namespace XCharts.Runtime
{
    ...
    public class Padding : ChildComponent
    {
        ...
        [SerializeField] protected float m_Bottom;
        ...
        public float top
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Top, value)) SetComponentDirty();
            }
        }
        ...
        public float right
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Right, value)) SetComponentDirty();
            }
        }
        ...
        public float bottom
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Bottom, value)) SetComponentDirty();
            }
        }
        ...
        public float left
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Left, value)) SetComponentDirty();
            }
        }
