...
namespace XCharts.Runtime
{
    ...
    public class LineStyle : ChildComponent, ISerieDataComponent
    {
        ...
        public float dashLength
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_DashLength, value)) SetVerticesDirty();
            }
        }
        ...
        public float dotLength
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_DotLength, value)) SetVerticesDirty();
            }
        }
        ...
        public float gapLength
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_GapLength, value)) SetVerticesDirty();
            }
        }
        ...
        {
            if (!ChartHelper.IsClearColor(this.color)) return GetColor();
