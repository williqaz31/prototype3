...
#pragma warning restore 0414
        ...
        [SerializeField] protected bool m_ShowAllChartObject;
        [SerializeField] protected bool m_FoldSeries;
        ...
        public void Update()
        {
            ...
            if (Time.realtimeSinceStartup - m_LastTime >= INTERVAL)
            {
                ...
                if (m_FpsList.Count > MAXCACHE) m_FpsList.RemoveAt(0);
                m_FpsList.Add(fps);
            ...
            ThemeStyle theme, List<string> childrenNodeNames)
        {
            ...
            var labelGameObject = ChartHelper.AddObject(name, parent, anchorMin, anchorMax, pivot, sizeDelta, -1,
                childrenNodeNames);
