...
namespace XCharts.Runtime
{
    ...
    public class AxisSplitLine : BaseLine
    {
        ...
        public bool showStartLine
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ShowStartLine, value)) SetVerticesDirty();
            }
        }
        ...
        public bool showEndLine
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ShowEndLine, value)) SetVerticesDirty();
            }
        }
        ...
        public bool showZLine
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ShowZLine, value)) SetVerticesDirty();
            }
        }
