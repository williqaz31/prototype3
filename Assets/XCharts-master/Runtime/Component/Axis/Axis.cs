...
namespace XCharts.Runtime
{
    ...
    public class Axis : MainComponent
    {
        ...
        [SerializeField] protected int m_SplitNumber;
        [SerializeField] protected double m_Interval;
        ...
        [SerializeField] protected bool m_LogBaseE;
        [SerializeField] protected double m_CeilRate;
        [SerializeField] protected bool m_Inverse;
        [SerializeField] private bool m_Clockwise = true;
        [SerializeField] private bool m_InsertDataToHead;
        [SerializeField] [Since("v3.11.0")] private float m_MinCategorySpacing;
        ...
        {
            internal get => m_OnLabelClick;
            set => m_OnLabelClick = value;
        }
        ...
        public bool inverse
        {
            ...
            set
            {
                if (m_Type == AxisType.Value && PropertyUtil.SetStruct(ref m_Inverse, value)) SetAllDirty();
            }
        }
        ...
        public float minCategorySpacing
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinCategorySpacing, value)) SetAllDirty();
            }
        }
        ...
        {
            if (total == 0) total = context.labelValueList.Count;
        ...
        public void AddData(string category)
        {
            if (maxCache > 0)
            {
                ...
                while (m_Data.Count >= maxCache) RemoveData(m_InsertDataToHead ? m_Data.Count - 1 : 0);
            }
        ...
        public float GetDistance(double value, float axisLength = 0)
        {
            if (context.minMaxRange == 0)
                return 0;
            if (axisLength == 0) axisLength = context.length;
        ...
        {
            if (context.minMaxRange > 0) return axisLength * (float)(value / context.minMaxRange);
        ...
        internal void UpdateMinMaxValue(double minValue, double maxValue, bool needAnimation = false)
        {
            ...
            if (context.minMaxRange != tempRange)
            {
                ...
                if (type == AxisType.Value && interval > 0) SetComponentDirty();
            }
        }
        ...
        public void UpdateZeroOffset(float axisLength)
        {
            context.offset = context.minValue > 0 || context.minMaxRange == 0 ? 0 :
                ...
                (float)(Math.Abs(context.minValue) *
                        (axisLength / (Math.Abs(context.minValue) + Math.Abs(context.maxValue))));
        }
