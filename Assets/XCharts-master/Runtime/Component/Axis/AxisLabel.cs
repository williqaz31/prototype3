...
namespace XCharts.Runtime
{
    ...
    public class AxisLabel : LabelStyle
    {
        ...
        public bool showZeroLabel
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ShowZeroLabel, value)) SetComponentDirty();
            }
        }
        ...
        public override string GetFormatterContent(int labelIndex, int totalIndex, double value, double minValue,
            double maxValue, bool isLog = false)
        {
            if (showAsPositiveNumber && value < 0) value = Math.Abs(value);
