...
namespace XCharts.Runtime
{
    ...
    public partial class BaseChart
    {
        ...
        public Painter topPainter => m_PainterTop;
            ...
            if (legendIndex >= 0)
                foreach (var component in m_Components)
                    if (component is Legend)
                    {
                        ...
                        var contentColor =
                            LegendHelper.GetContentColor(this, legendIndex, legendName, legend, m_Theme, active);
        ...
        public virtual bool IsActiveByLegend(string legendName)
        {
            foreach (var serie in m_Series)
            {
                if (serie.show && legendName.Equals(serie.serieName)) return true;
        ...
        public void SetBasePainterMaterial(Material material)
        {
            ...
            if (m_Painter != null) m_Painter.material = material;
        }
        ...
        public void SetUpperPainterMaterial(Material material)
        {
            ...
            if (m_PainterUpper != null) m_PainterUpper.material = material;
        }
        ...
        public void SetTopPainterMaterial(Material material)
        {
            ...
            if (m_PainterTop != null) m_PainterTop.material = material;
        }
        ...
        public Color32 GetMarkColor(Serie serie, SerieData serieData)
        {
            ...
            if (ChartHelper.IsClearColor(itemStyle.markColor)) return GetItemColor(serie, serieData);
