...
namespace XCharts.Runtime
{
        ...
        IDragHandler, IEndDragHandler, IScrollHandler
    {
        ...
        [SerializeField] protected List<string> m_ChildNodeNames = new();
        ...
        public List<string> childrenNodeNames => m_ChildNodeNames;
        ...
        {
#if UNITY_EDITOR
            if (!Application.isPlaying) m_IsOnValidate = true;
#endif
            m_PainerDirty = true;
        }
        ...
        private void CheckSize()
        {
            ...
            if (m_GraphWidth == 0 && m_GraphHeight == 0 && (currWidth != 0 || currHeight != 0)) Awake();
        ...
        private void CheckPointerPos()
        {
            ...
            if (pointerMoveEventData != null) pointerPos = MousePos2ChartPos(pointerMoveEventData.position);
        }

        private Vector2 MousePos2ChartPos(Vector2 mousePos)
        {
            Vector2 local;
            if (!ScreenPointToChartPoint(mousePos, out local)) return Vector2.zero;
