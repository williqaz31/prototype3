...
namespace XCharts.Runtime
{
    ...
    public class BaseAxisTheme : ComponentTheme
    {
        ...
        [SerializeField] protected float m_LineLength;
        ...
        [SerializeField] protected float m_SplitLineLength;
        ...
        {
            get => ChartHelper.IsClearColor(m_MinorSplitLineColor)
                ? ColorUtil.GetColor("#F4F7FD")
                : m_MinorSplitLineColor;
            set
            {
                if (PropertyUtil.SetColor(ref m_MinorSplitLineColor, value)) SetVerticesDirty();
            }
        }
