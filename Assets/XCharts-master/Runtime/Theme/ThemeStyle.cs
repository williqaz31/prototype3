...
namespace XCharts.Runtime
{
    ...
    public class ThemeStyle : ChildComponent
    {
        ...
        public void SyncSharedThemeColorToCustom()
        {
            ...
            foreach (var color in sharedTheme.colorPalette) m_CustomColorPalette.Add(color);
            SetAllDirty();
        }
...
#else
            if (sharedTheme.font == null) sb.AppendFormat("warning:theme->font is null\n");
#endif
            if (sharedTheme.colorPalette.Count == 0) sb.AppendFormat("warning:theme->colorPalette is empty\n");
