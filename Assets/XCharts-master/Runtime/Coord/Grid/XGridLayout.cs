...
namespace XCharts.Runtime
{
    ...
    public class GridLayout : MainComponent, IUpdateRuntimeData
    {
        ...
        public int row
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Row, value)) SetAllDirty();
            }
        }
        ...
        public int column
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Column, value)) SetAllDirty();
            }
        }
        ...
        public Vector2 spacing
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Spacing, value)) SetAllDirty();
            }
        }
        ...
        public bool inverse
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Inverse, value)) SetAllDirty();
            }
        }
