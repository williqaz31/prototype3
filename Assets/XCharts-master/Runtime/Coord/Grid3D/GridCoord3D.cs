...
namespace XCharts.Runtime
{
    ...
    public class ViewControl : ChildComponent
    {
        ...
        public float alpha
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Alpha, value)) SetVerticesDirty();
            }
        }
        ...
        public float beta
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Beta, value)) SetVerticesDirty();
            }
        }
    }
    ...
    public class GridCoord3D : CoordSystem, IUpdateRuntimeData, ISerieContainer
    {
        ...
        [SerializeField] private bool m_ShowBorder;
        ...
        [SerializeField] private bool m_XYExchanged;
        ...
        public bool showBorder
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ShowBorder, value)) SetVerticesDirty();
            }
        }
        ...
        public float boxWidth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BoxWidth, value)) SetVerticesDirty();
            }
        }
        ...
        public float boxHeight
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BoxHeight, value)) SetVerticesDirty();
            }
        }
        ...
        public float boxDepth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BoxDepth, value)) SetVerticesDirty();
            }
        }
        ...
        public bool xyExchanged
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_XYExchanged, value)) SetVerticesDirty();
            }
        }
        ...
        public void UpdateRuntimeData(BaseChart chart)
        {
            ...
            var minX = Mathf.Min(context.pointA.x, context.pointB.x, context.pointC.x, context.pointD.x,
                context.pointE.x, context.pointF.x, context.pointG.x, context.pointH.x);
            var minY = Mathf.Min(context.pointA.y, context.pointB.y, context.pointC.y, context.pointD.y,
                context.pointE.y, context.pointF.y, context.pointG.y, context.pointH.y);
            var maxX = Mathf.Max(context.pointA.x, context.pointB.x, context.pointC.x, context.pointD.x,
                context.pointE.x, context.pointF.x, context.pointG.x, context.pointH.x);
            var maxY = Mathf.Max(context.pointA.y, context.pointB.y, context.pointC.y, context.pointD.y,
                context.pointE.y, context.pointF.y, context.pointG.y, context.pointH.y);
        ...
        public bool Contains(Vector3 pos)
        {
            ...
            if (IsLeft())
                if (UGLHelper.IsPointInPolygon(pos, context.pointC, context.pointG, context.pointH, context.pointD))
                    return true;
                else if (UGLHelper.IsPointInPolygon(pos, context.pointA, context.pointE, context.pointF,
                             context.pointB)) return true;
            return false;
        }
