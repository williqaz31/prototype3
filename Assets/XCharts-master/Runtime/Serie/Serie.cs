...
namespace XCharts.Runtime
{
    ...
    public partial class Serie : BaseSerie, IComparable
    {
        ...
        [SerializeField] private int m_RadarIndex;
        [SerializeField] private int m_VesselIndex;
        [SerializeField] private int m_PolarIndex;
        [SerializeField] private int m_SingleAxisIndex;
        [SerializeField] private int m_ParallelIndex;
        ...
        [SerializeField] private float m_SampleDist;
        [SerializeField] private SampleType m_SampleType = SampleType.Average;
        [SerializeField] private float m_SampleAverage;

        [SerializeField] private LineType m_LineType = LineType.Normal;
        [SerializeField] [Since("v3.4.0")] private bool m_SmoothLimit;
        [SerializeField] private BarType m_BarType = BarType.Normal;
        [SerializeField] private bool m_BarPercentStack;
        [SerializeField] private float m_BarWidth;
        [SerializeField] [Since("v3.5.0")] private float m_BarMaxWidth;
        ...
        [SerializeField] [Since("v3.8.0")] private float m_MinRadius;
        [SerializeField] [Since("v3.10.0")] private bool m_MinShowLabel;
        [SerializeField] [Since("v3.10.0")] private double m_MinShowLabelValue;

        [SerializeField] [Range(2, 10)] private int m_ShowDataDimension;
        [SerializeField] private bool m_ShowDataName;
        [SerializeField] private bool m_Clip;
        [SerializeField] private bool m_Ignore;
        [SerializeField] private double m_IgnoreValue;
        [SerializeField] private bool m_IgnoreLineBreak;
        [SerializeField] private bool m_ShowAsPositiveNumber;
        [SerializeField] private bool m_Large = true;
        [SerializeField] private int m_LargeThreshold = 200;
        [SerializeField] private bool m_AvoidLabelOverlap;
        [SerializeField] private RadarType m_RadarType = RadarType.Multiple;
        [SerializeField] private bool m_PlaceHolder;
        ...
        [SerializeField] [Since("v3.14.0")] private bool m_RealtimeSort;
        ...
        public string coordSystem
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_CoordSystem, value, true)) SetVerticesDirty();
            }
        }
        ...
        public string serieType
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SerieType, value, true)) SetVerticesDirty();
            }
        }
        ...
        public SerieState state
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_State, value)) SetAllDirty();
            }
        }
        ...
        public SerieColorBy colorBy
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ColorBy, value)) SetAllDirty();
            }
        }
        ...
        public int singleAxisIndex
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_SingleAxisIndex, value)) SetAllDirty();
            }
        }
        ...
        public int parallelIndex
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ParallelIndex, value)) SetAllDirty();
            }
        }
        ...
        public bool smoothLimit
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_SmoothLimit, value)) SetVerticesDirty();
            }
        }
        ...
        public float barMaxWidth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BarMaxWidth, value)) SetVerticesDirty();
            }
        }
        ...
        public float minRadius
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinRadius, value)) SetVerticesDirty();
            }
        }
        ...
        public AnimationStyle animation
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Animation, value, true)) SetVerticesDirty();
            }
        }
        ...
        public bool large
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Large, value)) SetAllDirty();
            }
        }
        ...
        public int largeThreshold
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_LargeThreshold, value)) SetAllDirty();
            }
        }
        ...
        public bool placeHolder
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_PlaceHolder, value)) SetAllDirty();
            }
        }
        ...
        public bool minShowLabel
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinShowLabel, value)) SetVerticesDirty();
            }
        }
        ...
        public double minShowLabelValue
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinShowLabelValue, value)) SetVerticesDirty();
            }
        }
        ...
        public bool realtimeSort
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_RealtimeSort, value)) SetVerticesDirty();
            }
        }
        ...
        {
            while (m_Data.Count > 0) RemoveData(0);
            m_Data.Clear();
        ...
        public void RemoveData(int index)
        {
            ...
            {
                if (!string.IsNullOrEmpty(m_Data[index].name)) SetSerieNameDirty();
                SetVerticesDirty();
                var serieData = m_Data[index];
                SerieDataPool.Release(serieData);
                if (serieData.labelObject != null) SerieLabelPool.Release(serieData.labelObject.gameObject);
        ...
        /// <param name="dataId">the unique id of data</param>
        /// <returns></returns>
        public SerieData AddData(double indexOrTimestamp, double open, double close, double lowest, double heighest,
            string dataName = null, string dataId = null)
        {
            var flag = CheckMaxCache();
            var serieData = SerieDataPool.Get();
            serieData.data.Clear();
        ...
        public SerieData AddData(List<double> valueList, string dataName = null, string dataId = null)
        {
            ...
            serieData.index = m_Data.Count;
            serieData.id = dataId;
            for (var i = 0; i < valueList.Count; i++) serieData.data.Add(valueList[i]);
            AddSerieData(serieData);
            if (flag) ResetDataIndex();
            SetVerticesDirty();
            CheckDataName(dataName);
        ...
        public SerieData AddData(params double[] values)
        {
            ...
            serieData.index = m_Data.Count;
            serieData.id = dataId;
            for (var i = 0; i < values.Length; i++) serieData.data.Add(values[i]);
            AddSerieData(serieData);
            if (flag) ResetDataIndex();
            SetVerticesDirty();
            CheckDataName(dataName);
        ...
        public void AddChildData(SerieData parent, SerieData serieData)
        {
            ...
            if (!parent.context.children.Contains(serieData)) parent.context.children.Add(serieData);
        }
        ...
        public bool UpdateDataName(int index, string name)
        {
            if (index >= 0 && index < m_Data.Count)
            {
                ...
                serieData.name = name;
                SetSerieNameDirty();
                if (serieData.labelObject != null) serieData.labelObject.SetText(name == null ? "" : name);
                return true;
            }
        ...
        public float GetBarWidth(float categoryWidth, int barCount = 0, float defaultRate = 0.6f)
        {
            ...
            if (m_BarMaxWidth == 0) return realWidth;
        ...
        {
            if (index >= 0 && index < dataCount) return ChartHelper.IsIngore(data[index].context.position);
            return false;
        }
        ...
        {
            if (colorBy == SerieColorBy.Data) return IsSerieDataLegendName(legendName) || IsSerieLegendName(legendName);
